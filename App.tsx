  ...
  const onSubmit = async (values: LoginFormValues) => {
    try {
      ...
      if (res.user.role === "HOD") {
        router.replace("/(protected)/hod");
      } else if (res.user.role === "OFFICER")
        router.replace("/(protected)/officer");
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.field}>
            ...
            />
            {!!errors.imoNumber && (
              <Text style={styles.error}>{errors.imoNumber.message}</Text>
            )}
          </View>
          ...
          <View style={styles.field}>
            ...
            />
            {!!errors.crewId && (
              <Text style={styles.error}>{errors.crewId.message}</Text>
            )}
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.rowBetween}>
              ...
              <Pressable>
                <Text style={styles.reset}>EMERGENCY RESET</Text>
              </Pressable>
            </View>
            <Controller
              control={control}
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Current bridge location synced via encrypted GNSS. Satellite link
              active.
            </Text>
          </View>
